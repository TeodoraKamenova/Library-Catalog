...
test('Verify that logged-in user sees details button and button works correctlly', async ({ page }) => {
    await page.goto('http://localhost:3000/login');
    await page.fill('input[name="email"]', 'peter@abv.bg');
    await page.fill('input[name="password"]', '123456');
...
test('Verify that guest user sees details button and button works correctlly', async ({ page }) => {
